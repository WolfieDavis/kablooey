...
//int analogPin2 = A1;
//int chargePin2 = 7;
//int dischargePin2 = 6; //speeds up discharging process, not necessary though
...
//  }
//  int ana1=analogRead(analogPin1)/1023*255;
//  int ana2=analogRead(analogPin2)/1023*255;
//  unsigned long checkpoint1=micros();
...
//    tau1=checkpoint1-startTime1;
//    digitalWrite(chargePin1, LOW);
//  }
//   if (analogRead(analogPin2)>=648){ // cap2 reached 63.2%
//    tau2=checkpoint1-startTime2;
//    digitalWrite(chargePin2, LOW);
//  }
//
//  
